...
def seed_all_bookmakers(db: Session):
    ...
    bookmakers_data = [
        ...
        },
        {
            ...
            "is_active": False,
            "scraping_config": {"tier": "diamond", "platform": "standalone", "scraper_class": "chasebet"},
        },
        {
            "code": "diamondbet",
            "name": "DiamondBet",
        ...
        # ======================================================================
        # DIAMOND TIER - Punters Tech Platform (~15 skins, 1 scraper)
        # ======================================================================
        {
            "code": "tradiebet",
            "name": "TradieBet",
            "display_name": "TradieBet",
            "website_url": "https://www.tradiebet.com.au",
            "is_active": False,
            "scraping_config": {"tier": "diamond", "platform": "punters_tech", "scraper_class": "punters_tech"},
        },
        {
            "code": "mintbet",
            "name": "MintBet",
        ...
        },
        {
            ...
            "name": "VinBet",
            "display_name": "VinBet",
            "website_url": "https://www.vinbet.com.au",
            "is_active": False,
            "scraping_config": {"tier": "diamond", "platform": "punters_tech", "scraper_class": "punters_tech"},
        },
        {
        ...
        },
        {
            ...
            "name": "TopBet",
            "display_name": "TopBet",
            "website_url": "https://www.topbet.com.au",
            "is_active": False,
            "scraping_config": {"tier": "diamond", "platform": "punters_tech", "scraper_class": "punters_tech"},
        },
        {
            ...
            "website_url": "https://www.alphabetsports.com.au",
            "is_active": False,
            "scraping_config": {"tier": "diamond", "platform": "punters_tech", "scraper_class": "punters_tech"},
        },
        {
        ...
        },
        {
            "code": "havabet",
            "name": "HavaBet",
            "display_name": "HavaBet",
            "website_url": "https://www.havabet.com.au",
            "is_active": False,
            "scraping_config": {"tier": "diamond", "platform": "punters_tech", "scraper_class": "punters_tech"},
        },
    ]
